...
public class OwnerControllerTests {
    ...
    public void testProcessFindFormSuccess() throws Exception {
        given(this.owners.findListByLastName("")).willReturn(Lists.newArrayList(george, new Owner()));
    ...
    public void testProcessFindFormByLastName() throws Exception {
        given(this.owners.findListByLastName(george.getLastName())).willReturn(Lists.newArrayList(george));
        mockMvc.perform(get("/owners")
